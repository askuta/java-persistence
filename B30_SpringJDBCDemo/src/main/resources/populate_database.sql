...
INSERT INTO ADDRESS (CITY,COUNTRY,STREET,ZIPCODE)
   VALUES('BUDAPEST','HUNGARY','FUTO UTCA','1085');
...
INSERT INTO MENU (Restaurant_ID,FROMDATE, TODATE)
   VALUES (1, curdate(), curdate() + interval 1 month - interval 1 day);

-- insert 5 foods, add foods to the inserted menu
INSERT INTO FOOD (CALORIES,ISVEGAN,NAME,PRICE)
   VALUES (100,0,'Fish soup',1000);
INSERT INTO FOOD (CALORIES,ISVEGAN,NAME,PRICE)
   VALUES (200,1,'Margerita pizza',2000);
INSERT INTO FOOD (CALORIES,ISVEGAN,NAME,PRICE)
   VALUES (300,0,'Cordon bleu',3000);
INSERT INTO FOOD (CALORIES,ISVEGAN,NAME,PRICE)
   VALUES (400,0,'Tune steak',4000);
INSERT INTO FOOD (CALORIES,ISVEGAN,NAME,PRICE)
   VALUES (500,0,'Tender lion',5000);
...
INSERT INTO FOOD (CALORIES,ISVEGAN,NAME,PRICE)
   VALUES (600,0,'Lamb chops',6000);
INSERT INTO FOOD (CALORIES,ISVEGAN,NAME,PRICE)
   VALUES (700,0,'File mignon',7000);
